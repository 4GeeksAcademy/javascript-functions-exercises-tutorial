...
describe('The output should be 56899747', function () {
    beforeEach(() => {
        //here I import the HTML into the document
    });
    afterEach(() => { jest.resetModules(); });

    it('console.log() function should be called with superduper', function () {
        ...
        */
        ...
        expect(console.log).toHaveBeenCalledWith("superduper");
        expect(console.log).toBe(56899747);
