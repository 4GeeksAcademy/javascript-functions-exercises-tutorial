...
describe('All the javascript should match', function () {
    ...
    it('console.log() function should be called with calculateArea with the correct parameters', function () {
        ...
        */
        ...
        expect(console.log).toHaveBeenCalledWith(calculateArea(4,4));
        expect(console.log).toHaveBeenCalledWith(calculateArea(2,2));
        expect(console.log).toHaveBeenCalledWith(calculateArea(5,5));
